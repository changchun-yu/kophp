...
//            $var = UTF8::clean($var, Ko::$charset);

//            if (UTF8::strlen($var) > $length) {
             if(mb_strlen($var) > $length){
                // Encode the truncated string
                $str = htmlspecialchars(\mb_substr($var, 0, $length), ENT_NOQUOTES, Ko::$charset) . '&nbsp;&hellip;';
            } else {
                // Encode the string
                $str = htmlspecialchars($var, ENT_NOQUOTES, Ko::$charset);
            }
    ...
    public static function path($file)
    {
        if (strpos($file, APP_PATH) === 0) {
            ...
            $file = DOC_ROOT . DIRECTORY_SEPARATOR . substr($file, strlen(DOC_ROOT));
        }
    ...
    public static function source($file, $line_number, $padding = 5)
    {
        ...
        while (($row = fgets($file)) !== FALSE) {
            ...
            if ($line >= $range['start']) {
                ...
                $row = htmlspecialchars($row, ENT_NOQUOTES, Ko::$charset);
