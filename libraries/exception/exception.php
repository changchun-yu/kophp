...
use ko\Debug;
/**
 * Ko exception class. Translates exceptions using the [I18n] class.
 *
 * @package    Ko
 * @category   Exceptions
 * @author     Ko Team
...
class Exception extends \Exception {
    ...
    public static function _handler( \Throwable$e)
    {
        try {
            ...
            header('Content-Type: text/plain; charset=' . Ko::$charset, TRUE, 500);
    ...
    public static function log(\Throwable $e, $level = Log::EMERGENCY)
    {
        if (is_object(Ko::$log)) {
            ...
            Ko::$log->add($level, $error, NULL, array('exception' => $e));
    ...
    public static function response(\Throwable $e)
    {
        try {
            ...
            $response->headers('Content-Type', Exception::$error_view_content_type . '; charset=' . Ko::$charset);
